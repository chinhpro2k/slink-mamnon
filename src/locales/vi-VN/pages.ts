export default {
  ...
  'pages.login.failure': 'Tài khoản hoặc mật khẩu không chính xác. Vui lòng đăng nhập lại!',
  'pages.login.success': 'Đăng nhập thành công!',
  'pages.login.username.placeholder': 'Tài khoản',
  'pages.login.username.required': 'Bắt buộc',
  'pages.login.password.placeholder': 'Mật khẩu',
  'pages.login.password.required': 'Bắt buộc',
