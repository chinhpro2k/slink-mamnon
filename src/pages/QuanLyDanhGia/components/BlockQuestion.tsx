...
import MultipleChoice from '@/pages/QuanLyKhaoSat/components/QuestionType/MultipleChoice';
import SingleChoice from '@/pages/QuanLyKhaoSat/components/QuestionType/SingleChoice';
import GridChoice from '@/pages/QuanLyKhaoSat/components/QuestionType/GridChoice';
import NumericRange from '@/pages/QuanLyKhaoSat/components/QuestionType/NumericChoice';
...
const BlockQuestion = (props: { index: number; block: number; form?: string }) => {
  const { record } = useModel(props?.form === 'GiaoVien' ? 'quanlydanhgia' : 'formdanhgia');
